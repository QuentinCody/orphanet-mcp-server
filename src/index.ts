...
import { OrphanetDataDO } from "./do";

// Export Durable Object classes
export { OrphanetDataDO };

interface OrphanetEnv {
...
export class MyMCP extends StatelessMcpWorker {
    ...
    async init() {
        ...
        const env = this.env as unknown as OrphanetEnv;
...
export default {
    fetch(request: Request, env: Env, ctx: ExecutionContext) {
        ...
        if (url.pathname === "/health") {
            return buildHealthResponse("orphanet");
        }
        ...
        if (url.pathname === "/readyz") {
            ...
            return MyMCP.readiness(env, "orphanet");
        }
